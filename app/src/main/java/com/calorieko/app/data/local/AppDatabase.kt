...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        /**
         * Migration 23 -> 24: Adds serving quantity to meal log items.
         *
         * Existing meal items represent one serving by default.
         */
        val MIGRATION_23_24 = object : Migration(23, 24) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    "ALTER TABLE meal_log_item_table ADD COLUMN serving_quantity REAL NOT NULL DEFAULT 1"
                )
            }
        }
