...
suspend fun populateDatabase(foodDao: FoodDao) {
    val dishes = listOf(
        ...
        FoodItem(
            ...
            caloriesPer100g = 175.7f,
            proteinPer100g = 6.07f,
            carbsPer100g = 14.14f,
            fiberPer100g = 0.85f,
            sugarPer100g = 0.65f,
            fatPer100g = 10.50f,
            saturatedFatPer100g = 3.10f,
            polyunsaturatedFatPer100g = 1.80f,
            monounsaturatedFatPer100g = 4.20f,
            transFatPer100g = 0f,
            cholesterolPer100g = 132.8f,
            sodiumPer100g = 285f,
            potassiumPer100g = 115f,
            vitaminAPer100g = 455f, // µg
            vitaminCPer100g = 200f, // mg
            calciumPer100g = 85.7f, // mg
            ironPer100g = 0.43f // mg
        ),
        FoodItem(
            nameEn = "Udong",
            namePh = "Udong",
