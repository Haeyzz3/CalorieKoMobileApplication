...
def main():
    ...
    # ─── Append store-bought dishes (no CSV ingredients) ───
    # These are pre-cooked items with externally-sourced nutrition data.
    # They have no entries in dish_ingredients.csv so must be injected here.
    STORE_BOUGHT_DISHES = [
        {
            "dish_label": "chicken_wing",
            "name_en": "Rotisserie Chicken - Wing",
            "name_ph": "Lechon Manok - Pakpak",
            "category": "Main Dish",
            "cooking_method": "store_bought_roasted",
            "servings": 1,
            "total_raw_weight_g": 150.0,
            "dish_yield_factor": 1.0,
            "cooked_weight_g": 150.0,
            "per_serving_weight_g": 150.0,
            "total_nutrients_raw": {
                "calories": 385.5, "protein": 35.1, "carbs": 0.9, "fat": 27.0,
                "fiber": 0.0, "sugar": 0.9, "sodium": 868.5, "potassium": 427.5,
                "vitamin_a": 39.0, "vitamin_c": 0.0, "calcium": 49.5, "iron": 1.4
            },
            "per_serving_nutrients": {
                "calories": 385.5, "protein": 35.1, "carbs": 0.9, "fat": 27.0,
                "fiber": 0.0, "sugar": 0.9, "sodium": 868.5, "potassium": 427.5,
        ...
        },
        {
            ...
            "per_serving_weight_g": 150.0,
            "total_nutrients_raw": {
                "calories": 339.0, "protein": 33.75, "carbs": 0.18, "fat": 22.65,
                "fiber": 0.0, "sugar": 0.18, "sodium": 502.5, "potassium": 382.5,
                "vitamin_a": 30.0, "vitamin_c": 0.0, "calcium": 24.0, "iron": 1.42
            },
            "per_serving_nutrients": {
                "calories": 339.0, "protein": 33.75, "carbs": 0.18, "fat": 22.65,
                "fiber": 0.0, "sugar": 0.18, "sodium": 502.5, "potassium": 382.5,
        ...
        {
            "dish_label": "chicken_drumstick",
            "name_en": "Rotisserie Chicken - Drumstick",
            "name_ph": "Lechon Manok - Binti",
            "category": "Main Dish",
            "cooking_method": "store_bought_roasted",
            "servings": 1,
            "total_raw_weight_g": 130.0,
            "dish_yield_factor": 1.0,
            "cooked_weight_g": 130.0,
            "per_serving_weight_g": 130.0,
            "total_nutrients_raw": {
                "calories": 267.8, "protein": 33.28, "carbs": 0.16, "fat": 14.95,
                "fiber": 0.0, "sugar": 0.16, "sodium": 509.6, "potassium": 362.7,
                "vitamin_a": 22.1, "vitamin_c": 0.0, "calcium": 28.6, "iron": 1.33
            },
            "per_serving_nutrients": {
                "calories": 267.8, "protein": 33.28, "carbs": 0.16, "fat": 14.95,
                "fiber": 0.0, "sugar": 0.16, "sodium": 509.6, "potassium": 362.7,
        ...
        {
            "dish_label": "chicken_breast",
            "name_en": "Rotisserie Chicken - Breast",
            "name_ph": "Lechon Manok - Dibdib",
            "category": "Main Dish",
            "cooking_method": "store_bought_roasted",
            "servings": 1,
            "total_raw_weight_g": 200.0,
            "dish_yield_factor": 1.0,
            "cooked_weight_g": 200.0,
            "per_serving_weight_g": 200.0,
            "total_nutrients_raw": {
                "calories": 350.0, "protein": 52.8, "carbs": 0.18, "fat": 15.34,
                "fiber": 0.0, "sugar": 0.18, "sodium": 658.0, "potassium": 552.0,
                "vitamin_a": 22.0, "vitamin_c": 0.0, "calcium": 32.0, "iron": 1.02
            },
            "per_serving_nutrients": {
                "calories": 350.0, "protein": 52.8, "carbs": 0.18, "fat": 15.34,
                "fiber": 0.0, "sugar": 0.18, "sodium": 658.0, "potassium": 552.0,
    ...
    dish_recipes.extend(STORE_BOUGHT_DISHES)
